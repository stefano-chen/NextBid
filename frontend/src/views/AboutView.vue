...
<template>
  <div class="flex h-[calc(100vh-6rem)] flex-row items-center justify-between">
    <div class="flex h-full w-1/2 flex-col items-center justify-center gap-y-10 bg-violet p-8">
      ...
      <div>
        <p>
          Hi, I'm Stefano Chen a master's degree student in Computer Engineering <br />
          at the University of Trieste in Italy. <br />
          This is a exam project for the Web Development 2024-2025 course. <br />
